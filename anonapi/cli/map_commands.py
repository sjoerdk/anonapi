...
def add_study_folder(context: MapCommandContext, path):
    ...
    folder_source_id = SourceIdentifierFactory().get_source_identifier_for_key(
        f"folder:{path}"
    )
    ...
    row = [SourceIdentifierParameter(folder_source_id), PatientName(patient_name),
           PatientID(patient_id), Description(description)]
