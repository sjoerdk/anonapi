...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("12abc", ["12abc"]),
        ("123,124", ["123", "124"]),
        ("123-123", ["123"]),  # single-number range. bit weird but allowed
        ("123AB,124", ["124", "123AB"]),
        ("123-125", ["123", "124", "125"]),
        ("123-125,124", ["123", "124", "125"]),  # duplicates are discarded
        ("123-125,124-125", ["123", "124", "125"]),  # duplicates are discarded
        ("123,126-128", ["123", "126", "127", "128"]),
        ("123,126-128,abc", ["123", "126", "127", "128", "abc"]),
        ("123-128,10032", ["123", "124", "125", "126", "127", "128", "10032"]),
    ],
)
